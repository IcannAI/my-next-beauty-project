          ...
          <div className="flex-1 flex flex-col justify-center">
            <div className="flex flex-col md:flex-row md:items-center gap-6 mb-6">
              ...
              <div className="flex gap-3 justify-center">
                ...
                <Button variant="outline" className="rounded-full px-8 py-6 h-auto border-2 font-bold dark:border-gray-800 dark:text-gray-300">
                  私訊
                </Button>
              </div>
            </div>
              ...
              profile.liveStreams.map(stream => (
                ...
                >
                  ...
                  <Badge className={`
                    ...
                    ${stream.status === 'LIVE' ? 'bg-rose-500 text-white animate-pulse shadow-lg shadow-rose-200' : 
